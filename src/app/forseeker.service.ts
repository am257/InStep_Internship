...
export class ForseekerService {
  ...
  employee_register(body:any){
    ...
    headerR.append('Content-Type', 'application/json');
    headerR.append('Accept', 'application/json');
  
    headerR.append('Access-Control-Allow-Origin', 'http://localhost:4200');
    headerR.append('Access-Control-Allow-Credentials', 'true');
